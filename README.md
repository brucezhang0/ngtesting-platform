...
2. Run "git clone -b branch-1.0.x https://github.com/aaronchen2k/ngtesting-platform.git" or download branch-1.0.x codes;
...
4. Run "git clone -b branch-1.0.x https://github.com/aaronchen2k/ngtesting-platform.git" or download branch-1.0.x codes;
