...
2. Run "clone -b branch-1.0.x https://github.com/aaronchen2k/ngtesting-platform.git" and goto project dir;
...
4. Run "clone -b branch-1.0.x https://github.com/aaronchen2k/ngtesting-platform.git" and goto project dir;
